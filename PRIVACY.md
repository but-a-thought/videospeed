...
When you explicitly save a controller position, the extension stores that website's hostname and the chosen pixel offset in browser-local extension storage. This information remains on that device, is not synchronized, and is never transmitted to us or any third party.
